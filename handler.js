...
—◉ *إذا كنت تعتقد أن هذا خطأ ولديك دليل، فيمكنك الاتصال بمالك البوت لاستئناف التعليق.* —◉ *التواصل مع المطور:* wa.me/01115618853
╚═════════════════════╝
               `.trim();
              m.reply(messageText);
        ...
        const mystica = `${plugin.botAdmin || plugin.admin || plugin